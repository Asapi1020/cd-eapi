	...
	return raw.map((data) => {
		...
		return {
			...
			CDInfo: {
				...
				albinoAlphas:
					toBoolean(data.matchData.CDInfo.albinoAlphas) ??
				...
				disableRobots:
					toBoolean(data.matchData.CDInfo.disableRobots) ??
